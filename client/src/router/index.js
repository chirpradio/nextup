...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'album/:id', name: "album", component: Album, props: true, meta: { hideBreadcrumb: true }, },
      { path: "artist/:id", name: "artist", component: Artist, props: true, meta: { hideBreadcrumb: true }, },
      { 
        path: "search", 
        name: "Search", 
        component: Search, 
