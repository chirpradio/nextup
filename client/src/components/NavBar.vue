        ...
        <ul class="navbar-nav me-auto">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="music-menu-link">
              <router-link class="dropdown-item" to="/library">Home</router-link>
              <router-link class="dropdown-item" to="/library/search">Search</router-link>
              <router-link class="dropdown-item" to="/library/tag/heavy_rotation">Heavy Rotation</router-link>
              <router-link class="dropdown-item" to="/library/tag/light_rotation">Light Rotation</router-link>
              <router-link class="dropdown-item" to="/library/library_adds">Library Adds</router-link>              
            </div>
          </li>       
        </ul>
        <form id="navbarSearch" class="form-inline my-2 my-lg-0" v-on:submit.prevent="search">
