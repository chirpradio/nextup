<template>
  <div>
    ...
    >
      ...
      <div class="col-md-3 search_result__col">
        <AlbumTitleLink :album="hit._source" />
        <TagList :tags="hit._source.current_tags" />
      </div>
      <div class="col-md-2 search_result__col">{{ hit._source.label }}</div>
      <div class="col-md-1 search_result__col">{{ hit._source.year }}</div>
      <div class="col-md-3 search_result__col mt-2 mt-2-sm">
