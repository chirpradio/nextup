<template>
  <div>
    <button class="btn btn-link-chirp-red p-0 mb-3" @click="toggleFilters">{{toggleLabel}}</button>
    <form v-if="filtersOpen" class="col-sm-8" @submit.prevent="search"> 
      <div class="mb-3">
        <label for="search">Search term</label>
        <div class="col-sm-6">
          <input class="form-control" id="search" type="search" v-model="query.term" aria-label="search">
        </div>
      </div>
      <fieldset class="row mb-4">
        ...
        <div class="col-12 col-md-2 mb-3">
          ...
          <select id="track__duration_ms_gte_input" class="form-select form-select-sm" v-model="query.track.duration_ms.gte">
        ...
        <div class="col-12 col-md-2 mb-3">
          ...
          <select id="track__duration_ms_lte_input" class="form-select form-select-sm" v-model="query.track.duration_ms.lte">
        ...
        <div class="col-12 col-md-3">
          <label class="form-check-label" for="is_recommended">
            ...
            <div class="form-check form-switch">
              <input class="form-check-input" type="checkbox" id="is_compilation" v-model="query.track.is_recommended">
      ...
      <fieldset class="row mb-4">
        ...
        <div class="col-12 col-md-2 mb-3">
          ...
          <input class="form-control form-control-sm" id="label" type="search" v-model="query.album.label">
        </div>
        <div class="col-12 col-md-2 mb-3">
          <label class="" for="year">Year</label>
          <input class="form-control form-control-sm" id="year" type="number" v-model="query.album.year">
        </div>
        <div class="col-12 col-md-2 mb-3">
          <label class="" for="rotation">Rotation</label>
            <select id="rotation" class="form-select form-select-sm" v-model="query.album.rotation">
        ...
        <div class="col-12 col-md-2 mb-3">
          <label class="" for="local">Local</label>
            <select id="local" class="form-select form-select-sm" v-model="query.album.local">
              <option value="any">Any</option>
