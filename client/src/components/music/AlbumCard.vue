<template>
  <div class="card col-md-3 pt-2 border-top-0 border-right-0 border-left-0">      
    ...
    <div class="card-body pt-2 pb-4 px-0">
      ...
      <p class="mt-2">{{album.year}} – {{album.label}}<span v-if="album.disc_number"> – Disc {{album.disc_number}}</span></p>
