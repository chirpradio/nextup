<template>
  <div class="card col-md-3 pt-2 border-light">      
    ...
    <div class="card-body pt-2 pb-4 px-0">
      <h3 class="card-title"><router-link :to="{ name: 'album', params: { id: album.album_id.value }}">{{album.title}}</router-link></h3>
      ...
      <p class="my-2">{{album.year}} &middot; {{album.label}}<span v-if="album.disc_number"> – Disc {{album.disc_number}}</span></p>
